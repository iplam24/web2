<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="themsanpham.aspx.cs" Inherits="index.admin.adminn" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <h2>Thêm sản phẩm</h2>
    <div>
        <table class="auto-style1">
<tr>
    <td colspan="2"><h1 style="text-align:center;font-size:30px">Thêm sản phẩm mới</h1></td>
</tr>
<tr>
...
<tr>
    ...
    <td>
        <img id="imgPreview3" src="" alt="" width="200" height="200" />
