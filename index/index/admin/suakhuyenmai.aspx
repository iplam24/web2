<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="suakhuyenmai.aspx.cs" Inherits="index.admin.suakhuyenmai" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    <table class="auto-style1">
<tr>
    <td colspan="2"><h1 style="text-align:center;font-size:30px">Sửa khuyến mãi</h1></td>
</tr>
<tr>
...
<tr>
    ...
    <td>
        ...
        <asp:Label ID="labelAnh" runat="server" Text="Label"></asp:Label>
        <br />
    </td>
</tr>

<tr>
    <td class="auto-style2">Anh Cu</td>
    <td>
