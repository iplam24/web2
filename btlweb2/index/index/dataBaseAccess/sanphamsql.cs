...
namespace index.cs_sql
{
    ...
    public class sanphamsql
    {
        ...
        public void themSanPham(sanpham sp)
        {
            ...
            conn.moKetNoi();
            string sql = "INSERT INTO tbl_sanpham VALUES (@MaSP, @TenSP, @TenHang, @NgayPhatHanh, @KichThuocMan, @Chip, @Ram, @BoNho, @DungLuongPin, @HeDieuHanh, @TrongLuong, @GiaNhap, @GiaBan, @MauSac, @MoTa, @Anh1, @Anh2, @Anh3)";
            SqlCommand cmd = new SqlCommand(sql, conn.SQLConn);
